/* Programa feito pelo aluno Caio Chaves Lima. Este programa é um conversor de unidades de comprimento que permite transformar valores entre **metros**, **centímetros** e
 **milímetros**. Você informa o valor numérico, a unidade de origem (como "metro") e a unidade de destino (como "centimetro"), e o programa calcula e exibe o resultado da conversão 
 na tela.*/
